...
/**
 * ************************************************************* Get SMS Delivery Status API class
 * template using Apache's HttpClient v4.3.3 Java Version 6. Required libraries/jars:
 * httpcore-4.3.2.jar (and dependencies); httpclient-4.3.3.jar (and dependencies); log4j-1.2.17.jar.
...
public class GetSMSDeliveryStatus {
    ...
    public static void main(String[] args) {
        ...
        String token = "";
        String apiURL = "https://x.smart.com.ph/1/smsmessaging/outbound/" + senderAddress
                + "/requests/" + requestId + "/deliveryInfos";

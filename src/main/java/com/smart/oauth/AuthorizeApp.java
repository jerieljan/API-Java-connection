 ...
 * using Apache's HttpClient v4.3.3. Java Version 6. Required libraries/jars: httpcore-4.3.2.jar
 * (and dependencies); httpclient-4.3.3.jar (and dependencies); log4j-1.2.17.jar. NOTE: This is the
 * FIRST step to acquiring a token using OAuth
 *
 * @author MARebultan *************************************************************
 */
...
public class AuthorizeApp {
    ...
    public static void main(String[] args) {
        ...
        String apiURL = "https://x.smart.com.ph/oauth/authorize?response_type=code&client_id="
                + clientId + "&client_secret=" + clientSecret + "&redirect_uri=" + callbackURL
                + "&scope=SMS+MMS";

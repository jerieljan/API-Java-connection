 ...
 * using Apache's HttpClient v4.3.3 Java Version 6. Required libraries/jars: httpcore-4.3.2.jar (and
 * dependencies); httpclient-4.3.3.jar (and dependencies); log4j-1.2.17.jar. NOTE: This is the
 * SECOND step to acquiring a token using OAuth.
 *
 * @author MARebultan *************************************************************
 */
...
public class RetrieveToken {
    ...
    public static void main(String[] args) throws ParseException, IOException {
        ...
        String auth_code
                = ""; // Important: The auth_code is retrieved once you "Allow" your app to use
        ...
        parameters.add((new BasicNameValuePair("scope",
                "SMS+MMS"))); // scope = the allowed function(s) provided to your credential
        parameters.add((new BasicNameValuePair("grant_type",
                "authorization_code"))); // grant_type = whether you are requesting for an auth_code token
